...
import com.court_booking_project.court_booking_server.config.JWTConfig;
import com.court_booking_project.court_booking_server.controller.AuthenticationController;
...
public class AuthenticationServiceImpl implements IAuthenticationService {
    ...
    public AuthenticationServiceImpl(JWTConfig jwtConfig, IUserService userService) {
    ...
    public String generateToken(String email) {
        ...
        JWTClaimsSet claimsSet = new JWTClaimsSet.Builder()
                .subject(email)
                .issueTime(new Date())
                .expirationTime(new Date(Instant.now().plus(jwtConfig.getEXPIRATION_TIME(), ChronoUnit.SECONDS).toEpochMilli()))
                .claim("email", email)
                .build();
        ...
        try {
            jwsObject.sign(new MACSigner(jwtConfig.getSECRET()));
